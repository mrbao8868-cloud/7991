        ...
        >
            ...
            >
                <div className="p-6">
                    <div className="flex items-start">
                        ...
                        <div className="ml-4 text-left flex-grow">
                            ...
                            <p className="mt-1 text-sm text-slate-500">
                                Thêm và chọn Khóa API của Google AI Studio để sử dụng.
                            </p>
                        </div>
                         {isClosable && (
                    ...
                    <div className="mt-6">
                        ...
                        <div className="flex items-start space-x-2">
                            <textarea
                                ...
                                placeholder="Dán một hoặc nhiều Khóa API vào đây, phân cách bằng dấu phẩy, dấu cách hoặc xuống dòng."
                    ...
                    <div className="mt-6">
                        <h4 className="font-semibold text-slate-700 mb-2">Các khóa đã lưu</h4>
